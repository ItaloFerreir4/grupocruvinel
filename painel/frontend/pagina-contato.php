            ...
            <div class="col-md-6 col-sm-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Pagina Contato</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="body">     
                        <form method="post" id="form-1">
                            <div class="row clearfix">
                                <input type="hidden" class="form-control" name="paginaId" id="paginaId" value="16">
                        ...
                        <form method="post" id="form-2">
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-12 hidden">
                                    <div class="form-group">    
                                        <label>Imagem fundo</label>
                                        <button class="btn btn-default selecionarImagem" formConteudo="2" imagem="imagem3Conteudo" type="button" target="modalMidia" onClick="AbreModal(this)">Escolher Imagem</button>
                                        <img class="img-fluid" id="imagem3Conteudo" src="null" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 hidden">
                    ...
                    <div class="body">
                        <form method="post" id="formEmail1">
                            ...
                            <div class="row clearfix">                                
								...
								<div class="col-12">
                                    <div class="form-group">   
                                        <label>Assunto (colocar itens separados por virgular ",")</label>
                                        <div class="input-group">
