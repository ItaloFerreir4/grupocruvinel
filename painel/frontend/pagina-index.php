                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-12 hidden">
                                    <div class="form-group">  
                                        ...
                                        <img class="img-fluid wauto h200 objContain" id="imagem2Conteudo" src="" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">  
                                ...
                                <div class="col-lg-6 col-md-12 hidden">
                                    <div class="form-group">    
                                        ...
                                        <button class="btn btn-default selecionarImagem" formConteudo="4" imagem="imagem3Conteudo" type="button" target="modalMidia" onClick="AbreModal(this)">Escolher Imagem</button>
                                        <img class="img-fluid" id="imagem3Conteudo" src="null" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 hidden">
                                ...
                                <div class="col-lg-6 col-md-12 hidden">
                                    <div class="form-group">  
                                        <label>Legenda da imagem Video</label>                                            
                                        <input type="text" class="form-control" id="legendaImagem3Conteudo" name="legendaImagem3Conteudo">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 hidden">
                        ...
                        <form method="post" id="form-5">
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-12 hidden">
                                    <div class="form-group">    
                                        <label>Imagem Video</label>
                                        <button class="btn btn-default selecionarImagem" formConteudo="5" imagem="imagem3Conteudo" type="button" target="modalMidia" onClick="AbreModal(this)">Escolher Imagem</button>
                                        <img class="img-fluid" id="imagem3Conteudo" src="null" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 hidden">
