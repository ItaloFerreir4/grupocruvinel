                ...
                <div class="card">
                    ...
                    <div class="body">     
                        <form method="post" id="form-1">
                            <div class="row clearfix">
                                <input type="hidden" class="form-control" name="paginaId" id="paginaId" value="2">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-12 hidden">
                                    <div class="form-group">  
                                        ...
                                        <button class="btn btn-default selecionarImagem" imagem="imagem2Conteudo" type="button" target="modalMidia" onClick="AbreModal(this)">Escolher Imagem</button>
                                        <img class="img-fluid wauto h200 objContain" id="imagem2Conteudo" src="null" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 hidden">
                                ...
                                <div class="col-lg-6 col-md-12 hidden">
                                    <div class="form-group">  
                                        <label>Legenda da imagem 2</label>                                            
                                        <input type="text" class="form-control" id="legendaImagem2Conteudo" name="legendaImagem2Conteudo">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 hidden">
                        ...
                        <form method="post" id="form-5">
                            <div class="row clearfix">
                                ...
                                <div class="col-12">
                                    ...
                                    <button class="btn btn-success btn-cadastra hidden" type="button" id="btn-cadastra-conteudo-5" onClick="CadastraConteudo(5)">Cadastrar</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="body">   
                        <div class="row mb-1">
                            <div class="col-12">
                                <button type="button" class="btn btn-info btn-volta" style="float: right;" id="btn-volta-conteudo-6" onClick="ListaConteudo(6)"><span class="sr-only">Fechar</span> <i class="fa fa-reply"></i></button>
                                <button class="btn btn-primary btn-adiciona" style="float: right;" type="button" id="btn-adiciona-conteudo-6" onClick="MostraCadastro(6)">Adicionar</button>
                            </div>
                        </div>
                        <form method="post" id="form-6">
                            <div class="row clearfix mt-5">
                                ...
                                <div class="col-12">
                                    ...
                                    <button class="btn btn-success btn-cadastra" type="button" id="btn-cadastra-conteudo-6" onClick="CadastraConteudo(6)">Cadastrar</button>
                                </div>
                            </div>
                        </form>
                        <div id="tabela-6">
                            <div class="table-responsive">
                                <table class="table table-hover dataTable table-custom spacing5" id="tabela-conteudo-6">
                                    <thead>
                                        <tr>
                                            <th>Titulo</th>
                                            <th>Texto</th>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="body">   
                        <div class="row mb-1">
                            <div class="col-12">
                                <button type="button" class="btn btn-info btn-volta" style="float: right;" id="btn-volta-conteudo-7" onClick="ListaConteudo(7)"><span class="sr-only">Fechar</span> <i class="fa fa-reply"></i></button>
                                <button class="btn btn-primary btn-adiciona" style="float: right;" type="button" id="btn-adiciona-conteudo-7" onClick="MostraCadastro(7)">Adicionar</button>
                            </div>
                        </div>
                        <form method="post" id="form-7">
                            <div class="row clearfix mt-5">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">    
                                        <label>Imagem</label>
                                        <button class="btn btn-default selecionarImagem" formConteudo="7" imagem="imagem1Conteudo" type="button" target="modalMidia" onClick="AbreModal(this)">Escolher Imagem</button>
                                        <img class="img-fluid wauto h200" id="imagem1Conteudo" src="null" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 hidden">
                                    <div class="form-group">  
                                        <label>Imagem Mobile</label>
                                        <button class="btn btn-default selecionarImagem" formConteudo="7" imagem="imagem2Conteudo" type="button" target="modalMidia" onClick="AbreModal(this)">Escolher Imagem</button>
                                        <img class="img-fluid wauto h200" id="imagem2Conteudo" src="null" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <button class="btn btn-success btn-cadastra" type="button" id="btn-cadastra-conteudo-7" onClick="CadastraConteudo(7)">Cadastrar</button>
                                </div>
                            </div>
                        </form>
                        <div id="tabela-7">
                            <div class="table-responsive">
                                <table class="table table-hover dataTable table-custom spacing5" id="tabela-conteudo-7">
                                    <thead>
                                        <tr>
                                            <th>Imagem</th>
                                            <th>Ações</th>
                        ...
                        <form method="post" id="form-8">
                            <div class="row clearfix">
                                ...
                                <div class="col-12">
                                    ...
                                    <button class="btn btn-success btn-cadastra hidden" type="button" id="btn-cadastra-conteudo-8" onClick="CadastraConteudo(8)">Cadastrar</button>
                                </div>
                            </div>
                        </form>
                    </div>
